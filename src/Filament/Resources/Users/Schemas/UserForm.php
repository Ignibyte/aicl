...
class UserForm
{
    ...
    private static function getRolesSection(): Section
    {
                ...
                Placeholder::make('mfa_status')
                    ...
                    ->content(function (?Model $record): HtmlString {
                        ...
                        return new HtmlString(
                            ...
                            .'<svg class="h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path d="M10 1a4.5 4.5 0 0 0-4.5 4.5V9H5a2 2 0 0 0-2 2v6a2 2 0 0 0 2-2v-6a2 2 0 0 0-2-2h-.5V5.5A4.5 4.5 0 0 0 10 1Zm3 8V5.5a3 3 0 1 0-6 0V9h6Z" clip-rule="evenodd" /></svg>'
                            .'Not set up</span>'
                        );
                    }),
    ...
    public static function configure(Schema $schema): Schema
    {
        return $schema
            ->components([
                ...
                static::getRolesSection(),
                static::getSecuritySection(),
            ]);
    }
}
